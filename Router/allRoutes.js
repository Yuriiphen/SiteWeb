...
export const allRoutes = [
    ...
    new Route("/signin", "Connexion", "/pages/auth/signin.html", "/pages/js/auth/signin.js", ["disconnected"]),
    new Route("/signup", "Inscription", "/pages/auth/signup.html", "/pages/js/auth/signup.js", ["disconnected"]),
